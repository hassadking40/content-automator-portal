  ...
  return (
    ...
    >
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl font-semibold mb-4">{t('why.work')}</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-6">{t('open.positions')}</h2>
            ...
            {positions.map((position, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <Button variant="outline">{t('view.position')}</Button>
                </div>
              </div>
            ))}
          </div>
